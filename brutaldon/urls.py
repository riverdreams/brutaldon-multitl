...
urlpatterns = [
    ...
    path("multihome/next/<next>", views.multihome, name="multihome_next"),
    path("multihome/prev/<prev>", views.multihome, name="multihome_prev"),
    path("multihome", views.multihome, name="multihome"),
    ...
    path("multilocal", views.multilocal, name="multilocal"),
    path("multilocal/next/<next>", views.multilocal, name="multilocal_next"),
    path("multilocal/prev/<prev>", views.multilocal, name="multilocal_prev"),
    ...
    path("multifed/next/<next>", views.multifed, name="multifed_next"),
    path("multifed/prev/<prev>", views.multifed, name="multifed_prev"),
